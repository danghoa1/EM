...
/**
  ...
  e.g. javac -classpath inflib.jar ProbabilityQuerySample.java

  To run it, do the same,
  but also include the path to
  the compiled class,
  e.g. java -classpath .:inflib.jar ProbabilityQuerySample

  @author Keith Cascio
  @since Apr 19, 2013 9:43:10 PM
*/
public class ProbabilityQuerySample
{
  /** Test. */
  public static void main(String[] args){
    ProbabilityQuerySample T = new ProbabilityQuerySample();
